...
internal static class BenchData
{
    ...
    /// Unlike "text" (a closed 12-word vocabulary — a near-worst-case for a chain-based match
    /// finder), this has realistic identifier/operator diversity and locally repetitive structure
    /// (indentation, braces), so it's representative of what compressing real text/code looks like.
    /// No network dependency: the source tree ships with the repo.
    /// </summary>
