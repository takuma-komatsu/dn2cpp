...
| 39 | core-text | **Support `Encoding.ASCII.GetString` ([GitHub issue #50](https://github.com/takuma-komatsu/dn2cpp/issues/50)).** Add an exact ASCII decoder and runtime encoding dispatch for the modeled array, span and pointer overloads; prove decoding, replacement fallback and argument validation in the CharText exact-diff gate. |
