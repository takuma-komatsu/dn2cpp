...
# the crypto, Crc32, Dp, Rdm and Sve families. Rows and Lowered flags come from
# the generated transpiler table, so a family promoted to Lowered joins the
# supported runs with no edit here.
...
# every optional family and our mask allows the two baseline ones.
...
PLATFORM_ISA_P_TRUE="Arm.AdvSimd"
PLATFORM_ISA_P_FALSE="Arm.Aes"
