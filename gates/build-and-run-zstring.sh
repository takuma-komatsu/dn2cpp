...
gate_run_logs_init zstring ZString
...
gate_run_diagnostics() {
    gate_run_diag "ZString native" "$native_code" "$native" "$native_stderr"
    gate_run_diag "ZString oracle" "$expected_code" "$expected" "$oracle_stderr"
}
