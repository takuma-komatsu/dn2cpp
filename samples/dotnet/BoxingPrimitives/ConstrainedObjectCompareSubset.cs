...
// CompareTo(object) on a primitive or string through the mouths that do not name
// the type's own method — a constrained call to IComparable.CompareTo(object) under
// a generic, and a boxed receiver — plus the direct object overload. Each answers
// the type's own CompareTo: null sorts first, and a box of another type throws
// .NET's ArgumentException naming the receiver's type.
