...
assembly references either, every application type that a retained body names
with `typeof` or a retained custom attribute names in a `Type` argument, open
generic definitions included, retains its instance constructors.
