    ...
    internal EmittedSources Emit(Action<string, string> writeChunk, int splitBytes = 1 << 20)
    {
        ...
        void EmitBody(MethodInfo m, string body)
        {
            ...
            if (_c.ObfuscationEnabled)
                _obfuscationBodyFiles[m] = m.FastMath ? "generated_hot_fast.cpp"
                    : m.IsHotPath ? "generated_hot.cpp"
                    : unsplitBodies is not null ? "generated.cpp"
                    : $"generated_b{o.BodyChunks}.cpp";
        }
        ...
        if (_c.ObfuscationEnabled)
            writeChunk("obfuscation-targets.json", BuildObfuscationTargets());
